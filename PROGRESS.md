...
- [ ] Grafana shows live p50/p99 enqueue-to-start latency under a loadgen ramp (100 → 2000 tasks/sec)
- [ ] Killing a worker mid-run produces a visible p99 spike + recovery on the graph
